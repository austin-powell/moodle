...
$string['classify_coursedates'] = 'By Course Dates';
$string['classify_enroldates'] = 'By Enrolment Dates';
...
$string['navclassifymycourses'] = 'Classify my courses';
$string['navclassifymycourses_desc'] = "Select method to use for classifying courses for timeline.<br>Course dates will classify courses by their start and end dates.<br>Enrolment dates will classify courses based on the user's enrolment start and end dates.";
